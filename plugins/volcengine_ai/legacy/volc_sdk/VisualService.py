...
from .base.service import ApiInfo
from .base.auth import Credentials
from .base.service import Service
from .base.service import ServiceInfo
...
class VisualService(Service):
    ...
    def img2img_anime_accelerated_maintain_id(self, form):
        try:
            res_json = self.common_json_handler(
                "Img2ImgAnimeAcceleratedMaintainID", form)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def img2img_create_disney_style_no_face(self, form):
        try:
            res_json = self.common_json_handler(
                "Img2ImgCreateDisneyStyleNoFace", form)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def img2img_create_pastel_boys2d(self, form):
        try:
            res_json = self.common_json_handler(
                "Img2ImgCreatePastelBoys2D", form)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def img2img_create_ether_real_mix(self, form):
        try:
            res_json = self.common_json_handler(
                "Img2ImgCreateEtherRealMix", form)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def img2img_create_anylora_makoto(self, form):
        try:
            res_json = self.common_json_handler(
                "Img2ImgCreateAnyloraMakoto", form)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def product_search_add_image(self, params):
        try:
            res_json = self.json("ProductSearchAddImage",
                                 [], json.dumps(params))
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def product_search_delete_image(self, params):
        try:
            res_json = self.json("ProductSearchDeleteImage",
                                 [], json.dumps(params))
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def product_search_search_image(self, params):
        try:
            res_json = self.json("ProductSearchSearchImage",
                                 [], json.dumps(params))
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def video_over_resolution_submit_task_v2(self, body):
        try:
            res_json = self.common_json_handler(
                "VideoOverResolutionSubmitTaskV2", body)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def video_over_resolution_get_result_v2(self, body):
        try:
            res_json = self.common_json_handler(
                "VideoOverResolutionQueryTaskV2", body)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def face_fusion_movie_submit_task(self, body):
        try:
            res_json = self.common_json_handler(
                "FaceFusionMovieSubmitTask", body)
            return res_json
        except Exception as e:
            raise Exception(str(e))
    ...
    def lens_vida_video_submit_task_v2(self, body):
        try:
            res_json = self.common_json_handler(
                "LensVidaVideoSubmitTaskV2", body)
            return res_json
        except Exception as e:
            raise Exception(str(e))
